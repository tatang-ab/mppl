...
<div class="post">
	<h2 class="title"><a href="#">Halaman Nilai</a></h2>
	...
	<div class="entry">
		...
		while($row=mysql_fetch_array($kelas)){
			...
			?>
			<tr>
				<td align="center"><?php echo $c=$c+1; ?></td><td align="center"><?php echo $row['nama_kelas']; ?></td>
				<td align="center"><?php echo $jumlah;?> Orang</td>
				<td align="center"><a href="?page=input_nilai&kd_kelas=<?php echo $row['kd_kelas'];?>">Input Nilai</a></td>
			</tr>
			<?php
		}
		?>
